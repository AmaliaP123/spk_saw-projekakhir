                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li
                                ...
                                <?php if( $this->uri->segment(1) == 'pelamar'){
                                    ?>
                                    class="active"
                                    <?php
                                }?>
                            ...
                            <li
                                <?php if( $this->uri->segment(1) == 'seleksi'){
                                    ?>
                                    class="active"
                                    <?php
                                }?>
                            ...
                            <ul class="dropdown-menu">
                                <li
                             <?php if( $this->uri->segment(1) == 'lappelamar'){
                                 ?>
                                    class="active"
                                 <?php
                             }?>
                            ><a href="<?php echo site_url('pelamar/cetak');?>" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;Laporan Data Pelamar</a></li>
                                <li><a href="<?= site_url() ?>rangking/cetak" target="_blank"><span class="glyphicon glyphicon-print"></span>&nbsp;Laporan Hasil Seleksi</a></li>
                            </ul>
                        </li>
                        </ul>
